function generateEvalUrl(type, name) {
  let fileName =
    type + (name || "") + "_" + Math.floor(Math.random() * 1000000000) + ".js";
  return "http://fromjs-temporary-url.com:5555/" + fileName;
}

export default function handleEvalScript(
  code,
  compile,
  details,
  done,
