    ...
    download(file).then(function(content){
        ...
        mkdirp(dir, function(){
            if (endsWith(fileName, ".html")){
                ...
                content = content.replace('<script src="js/app.js"></script>', '<script src="js/app.js"></script>' + ` <script>
                  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
                  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
                  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
                  })(window,document,'script','https://www.google-analytics.com/analytics.js','ga');

                  ga('create', 'UA-80477434-1', 'auto');
                  ga('send', 'pageview');
                </script>`)
            }
...
// /usr/local/bin/minify ./gh-pages/react-todomvc/fromjs-internals -d ./gh-pages/react-todomvc/fjsimin   