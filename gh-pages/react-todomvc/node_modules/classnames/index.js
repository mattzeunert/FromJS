...
(function () {
	...
	function classNames() {
		...
		for (var i = 0; i < arguments.length; i++) {
			...
			var argType = typeof arg === 'undefined' ? 'undefined' : f__typeof(arg);
			...
			if (f__useValue(f__useValue((f__setCachedValue(f__tripleEqual(argType, f__StringLiteral('string'))), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : f__tripleEqual(argType, f__StringLiteral('number')))) {
				...
				for (var __fromJSForIn88 in arg) {
					var key;key = f__getTrackedPropertyName(arg, __fromJSForIn88);
	...
	if (f__useValue(f__useValue((f__setCachedValue(f__notTripleEqual(typeof module === 'undefined' ? 'undefined' : f__typeof(module), f__StringLiteral('undefined'))), f__useValue(f__getCachedValue()))) ? module.exports : f__getCachedValue())) {
		module.exports = classNames;
	} else if (f__useValue(f__useValue((f__setCachedValue(f__useValue((f__setCachedValue(f__tripleEqual(typeof define === 'undefined' ? 'undefined' : f__typeof(define), f__StringLiteral('function'))), f__useValue(f__getCachedValue()))) ? f__tripleEqual(typeof define.amd === 'undefined' ? 'undefined' : f__typeof(define.amd), f__StringLiteral('object')) : f__getCachedValue()), f__useValue(f__getCachedValue()))) ? define.amd : f__getCachedValue())) {
