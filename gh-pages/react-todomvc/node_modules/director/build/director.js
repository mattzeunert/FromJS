...
(function (exports) {
  ...
  var listener = f__makeObject([[f__StringLiteral('mode'), f__StringLiteral('modern')], [f__StringLiteral('hash'), dloc.hash], [f__StringLiteral('history'), false], [f__StringLiteral('check'), function () {
    var h = dloc.hash;
    if (f__useValue(h != this.hash)) {
      this.hash = h;
      this.onHashChanged();
    }
  }], [f__StringLiteral('fire'), function () {
  ...
  }], [f__StringLiteral('init'), function (fn, history) {
    var self = this;
    ...
    if (f__useValue(f__useValue((f__setCachedValue(f__StringLiteral('onhashchange') in window), f__useValue(f__getCachedValue()))) ? f__useValue((f__setCachedValue(f__tripleEqual(document.documentMode, undefined)), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : document.documentMode > 7 : f__getCachedValue())) {
      ...
      this.mode = f__StringLiteral('modern');
    } else {
      //
      // IE support, based on a concept by Erik Arvidson ...
      //
      var frame = document.createElement(f__StringLiteral('iframe'));
      frame.id = f__StringLiteral('state-frame');
      frame.style.display = f__StringLiteral('none');
      ...
      this.mode = f__StringLiteral('legacy');
    }

    Router.listeners.push(fn);

    return this.mode;
  }], [f__StringLiteral('destroy'), function (fn) {
  ...
  }], [f__StringLiteral('setHash'), function (s) {
    ...
    if (f__useValue(f__tripleEqual(this.history, true))) {
      ...
      dloc.hash = f__useValue(f__tripleEqual(s[0], f__StringLiteral('/'))) ? s : f__add(f__StringLiteral('/'), s);
    }
    return this;
  }], [f__StringLiteral('writeFrame'), function (s) {
    // IE support...
    ...
    d.close();
  }], [f__StringLiteral('syncHash'), function () {
    // IE support...
    var s = this._hash;
    if (f__useValue(s != dloc.hash)) {
      dloc.hash = s;
    }
    return this;
  }], [f__StringLiteral('onHashChanged'), function () {}]]);

  var Router = exports.Router = function (routes) {
    if (f__useValue(f__not(this instanceof Router))) return new Router(routes);

    this.params = f__makeObject([]);
    this.routes = f__makeObject([]);
    this.methods = [f__StringLiteral('on'), f__StringLiteral('once'), f__StringLiteral('after'), f__StringLiteral('before')];
    this.scope = [];
    this._methods = f__makeObject([]);

    this._insert = this.insert;
    this.insert = this.insertEx;

    this.historySupport = (f__useValue(window.history != null) ? window.history.pushState : null) != null;
  ...
  Router.prototype.setRoute = function (i, v, val) {
    ...
    if (f__useValue(f__useValue((f__setCachedValue(f__tripleEqual(typeof i === 'undefined' ? 'undefined' : f__typeof(i), f__StringLiteral('number'))), f__useValue(f__getCachedValue()))) ? f__tripleEqual(typeof v === 'undefined' ? 'undefined' : f__typeof(v), f__StringLiteral('string')) : f__getCachedValue())) {
      f__assign(url, i, v);
    } else if (f__useValue(f__tripleEqual(typeof val === 'undefined' ? 'undefined' : f__typeof(val), f__StringLiteral('string')))) {
      url.splice(i, v, s);
    } else {
      url = [i];
    }
  ...
  Router.prototype.getRoute = function (v) {
    ...
    if (f__useValue(f__tripleEqual(typeof v === 'undefined' ? 'undefined' : f__typeof(v), f__StringLiteral('number')))) {
      ret = this.explode()[v];
    } else if (f__useValue(f__tripleEqual(typeof v === 'undefined' ? 'undefined' : f__typeof(v), f__StringLiteral('string')))) {
      var h = this.explode();
      ret = h.indexOf(v);
    } else {
      ret = this.explode();
  ...
  function _every(arr, iterator) {
    for (var i = 0; i < arr.length; i = f__add(i, 1)) {
  ...
  function paramifyString(str, params, mod) {
    mod = str;
    for (var __fromJSForIn86 in params) {
      var param;param = f__getTrackedPropertyName(params, __fromJSForIn86);
  ...
  function terminator(routes, delimiter, start, stop) {
    var last = 0,
        left = 0,
        right = 0,
        start = (f__useValue((f__setCachedValue(start), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : f__StringLiteral('(')).toString(),
        stop = (f__useValue((f__setCachedValue(stop), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : f__StringLiteral(')')).toString(),
        i;
  ...
  Router.prototype.configure = function (options) {
    ...
    this.recurse = f__useValue((f__setCachedValue(f__useValue((f__setCachedValue(options.recurse), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : this.recurse), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : false;
    this.async = f__useValue((f__setCachedValue(options.async), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : false;
    this.delimiter = f__useValue((f__setCachedValue(options.delimiter), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : f__StringLiteral('/');
    this.strict = f__useValue(f__tripleEqual(typeof options.strict === 'undefined' ? 'undefined' : f__typeof(options.strict), f__StringLiteral('undefined'))) ? true : options.strict;
    this.notfound = options.notfound;
    this.resource = options.resource;
    this.history = f__useValue((f__setCachedValue(f__useValue((f__setCachedValue(options.html5history), f__useValue(f__getCachedValue()))) ? this.historySupport : f__getCachedValue()), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : false;
    this.run_in_init = f__useValue((f__setCachedValue(f__tripleEqual(this.history, true)), f__useValue(f__getCachedValue()))) ? f__notTripleEqual(options.run_handler_in_init, false) : f__getCachedValue();
    this.convert_hash_in_init = f__useValue((f__setCachedValue(f__tripleEqual(this.history, true)), f__useValue(f__getCachedValue()))) ? f__notTripleEqual(options.convert_hash_in_init, false) : f__getCachedValue();
    this.every = f__makeObject([[f__StringLiteral('after'), f__useValue((f__setCachedValue(options.after), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : null], [f__StringLiteral('before'), f__useValue((f__setCachedValue(options.before), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : null], [f__StringLiteral('on'), f__useValue((f__setCachedValue(options.on), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : null]]);
    return this;
  };
  ...
  Router.prototype.on = Router.prototype.route = function (method, path, route) {
    var self = this;
    if (f__useValue(f__useValue((f__setCachedValue(f__not(route)), f__useValue(f__getCachedValue()))) ? (typeof path === 'undefined' ? 'undefined' : f__typeof(path)) == f__StringLiteral('function') : f__getCachedValue())) {
      route = path;
      path = method;
      method = f__StringLiteral('on');
    }
  ...
  Router.prototype.dispatch = function (method, path, callback) {
    ...
    if (f__useValue(f__useValue((f__setCachedValue(f__not(fns)), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : f__tripleEqual(fns.length, 0))) {
      this.last = [];
      if (f__useValue(f__tripleEqual(typeof this.notfound === 'undefined' ? 'undefined' : f__typeof(this.notfound), f__StringLiteral('function')))) {
        this.invoke([this.notfound], f__makeObject([[f__StringLiteral('method'), method], [f__StringLiteral('path'), path]]), callback);
      }
      return false;
    }
  ...
  Router.prototype.invoke = function (fns, thisArg, callback) {
    ...
    if (f__useValue(this.async)) {
      apply = function (fn, next) {
        ...
        } else if (f__useValue((typeof fn === 'undefined' ? 'undefined' : f__typeof(fn)) == f__StringLiteral('function'))) {
      ...
      apply = function (fn) {
        ...
        } else if (f__useValue(f__tripleEqual(typeof fn === 'undefined' ? 'undefined' : f__typeof(fn), f__StringLiteral('function')))) {
          return fn.apply(thisArg, f__useValue((f__setCachedValue(fns.captures), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : []);
        } else if (f__useValue(f__useValue((f__setCachedValue(f__tripleEqual(typeof fn === 'undefined' ? 'undefined' : f__typeof(fn), f__StringLiteral('string'))), f__useValue(f__getCachedValue()))) ? self.resource : f__getCachedValue())) {
  ...
  Router.prototype.traverse = function (method, path, routes, regexp, filter) {
    ...
    for (var __fromJSForIn87 in routes) {
      var r;r = f__getTrackedPropertyName(routes, __fromJSForIn87);

      if (f__useValue(f__useValue((f__setCachedValue(routes.hasOwnProperty(r)), f__useValue(f__getCachedValue()))) ? f__useValue((f__setCachedValue(f__not(this._methods[r])), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : f__useValue((f__setCachedValue(f__useValue((f__setCachedValue(this._methods[r]), f__useValue(f__getCachedValue()))) ? f__tripleEqual(typeof routes[r] === 'undefined' ? 'undefined' : f__typeof(routes[r]), f__StringLiteral('object')) : f__getCachedValue()), f__useValue(f__getCachedValue()))) ? f__not(Array.isArray(routes[r])) : f__getCachedValue() : f__getCachedValue())) {
        var r;r = f__getTrackedPropertyName(routes, __fromJSForIn87);
        ...
        if (f__useValue(f__useValue((f__setCachedValue(f__useValue((f__setCachedValue(match[0]), f__useValue(f__getCachedValue()))) ? match[0] == path : f__getCachedValue()), f__useValue(f__getCachedValue()))) ? routes[r][method] : f__getCachedValue())) {
          var r;r = f__getTrackedPropertyName(routes, __fromJSForIn87);
        ...
        if (f__useValue(next.matched)) {
          ...
          if (f__useValue(this.recurse)) {
            ...
            if (f__useValue(f__tripleEqual(routes, this.routes))) {
              ...
              next.after = next.after.concat([routes[f__StringLiteral('after')]].filter(Boolean));
            }
          }
          fns.matched = true;
  ...
  Router.prototype.insert = function (method, path, route, parent) {
    ...
    if (f__useValue(f__useValue((f__setCachedValue(f__useValue((f__setCachedValue(f__not(part)), f__useValue(f__getCachedValue()))) ? f__not(path.length) : f__getCachedValue()), f__useValue(f__getCachedValue()))) ? f__tripleEqual(parent, this.routes) : f__getCachedValue())) {
      methodType = typeof parent[method] === 'undefined' ? 'undefined' : f__typeof(parent[method]);
    ...
    parentType = typeof parent[part] === 'undefined' ? 'undefined' : f__typeof(parent[part]);
    isArray = Array.isArray(parent[part]);
    if (f__useValue(f__useValue((f__setCachedValue(f__useValue((f__setCachedValue(parent[part]), f__useValue(f__getCachedValue()))) ? f__not(isArray) : f__getCachedValue()), f__useValue(f__getCachedValue()))) ? parentType == f__StringLiteral('object') : f__getCachedValue())) {
      methodType = typeof parent[part][method] === 'undefined' ? 'undefined' : f__typeof(parent[part][method]);
    ...
    } else if (f__useValue(parentType == f__StringLiteral('undefined'))) {
  ...
  Router.prototype.mount = function (routes, path) {
    if (f__useValue(f__useValue((f__setCachedValue(f__useValue((f__setCachedValue(f__not(routes)), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : f__notTripleEqual(typeof routes === 'undefined' ? 'undefined' : f__typeof(routes), f__StringLiteral('object'))), f__useValue(f__getCachedValue()))) ? f__getCachedValue() : Array.isArray(routes))) {
      return;
    }
    var self = this;
    ...
    function insertOrMount(route, local) {
      var rename = route,
          ...
          routeType = typeof routes[route] === 'undefined' ? 'undefined' : f__typeof(routes[route]),
    ...
    for (var __fromJSForIn88 in routes) {
      var route;route = f__getTrackedPropertyName(routes, __fromJSForIn88);
...
})(f__useValue(f__tripleEqual(typeof exports === 'undefined' ? 'undefined' : f__typeof(exports), f__StringLiteral('object'))) ? exports : window);
