...
(function (exports) {
  ...
  function paramifyString(str, params, mod) {
    mod = str;
    for (var __fromJSForIn2 in params) {
      var param;param = f__getTrackedPropertyName(params, __fromJSForIn2);
  ...
  Router.prototype.traverse = function (method, path, routes, regexp, filter) {
    ...
    for (var __fromJSForIn3 in routes) {
      var r;r = f__getTrackedPropertyName(routes, __fromJSForIn3);
  ...
  Router.prototype.mount = function (routes, path) {
    ...
    for (var __fromJSForIn4 in routes) {
      var route;route = f__getTrackedPropertyName(routes, __fromJSForIn4);
