...
(function (exports) {
  ...
  function paramifyString(str, params, mod) {
    mod = str;
    for (var __fromJSForIn85 in params) {
      var param;param = f__getTrackedPropertyName(params, __fromJSForIn85);
  ...
  Router.prototype.traverse = function (method, path, routes, regexp, filter) {
    ...
    for (var __fromJSForIn86 in routes) {
      var r;r = f__getTrackedPropertyName(routes, __fromJSForIn86);
  ...
  Router.prototype.mount = function (routes, path) {
    ...
    for (var __fromJSForIn87 in routes) {
      var route;route = f__getTrackedPropertyName(routes, __fromJSForIn87);
