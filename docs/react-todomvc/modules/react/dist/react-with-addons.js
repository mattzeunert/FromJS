...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    ...
    var CSSPropertyOperations = f__makeObject([["ObjectProperty", f__StringLiteral("createMarkupForStyles"), function (styles) {
      ...
      for (var __fromJSForIn362 in f__getForInLoopKeyObject(styles)) {
        var styleName;styleName = f__getTrackedPropertyName(styles, __fromJSForIn362);
      ...
      for (var __fromJSForIn363 in f__getForInLoopKeyObject(styles)) {
        var styleName;styleName = f__getTrackedPropertyName(styles, __fromJSForIn363);
        ...
        if (f__useValue(styleValue)) {
          ...
          if (f__useValue(expansion)) {
            ...
            for (var __fromJSForIn364 in f__getForInLoopKeyObject(expansion)) {
              var individualStyleName;individualStyleName = f__getTrackedPropertyName(expansion, __fromJSForIn364);
              var styleName;styleName = f__getTrackedPropertyName(styles, __fromJSForIn363);
    ...
    var DOMPropertyInjection = f__makeObject([["ObjectProperty", f__StringLiteral("MUST_USE_ATTRIBUTE"), 0x1], ["ObjectProperty", f__StringLiteral("MUST_USE_PROPERTY"), 0x2], ["ObjectProperty", f__StringLiteral("HAS_SIDE_EFFECTS"), 0x4], ["ObjectProperty", f__StringLiteral("HAS_BOOLEAN_VALUE"), 0x8], ["ObjectProperty", f__StringLiteral("HAS_NUMERIC_VALUE"), 0x10], ["ObjectProperty", f__StringLiteral("HAS_POSITIVE_NUMERIC_VALUE"), 0x20 | 0x10], ["ObjectProperty", f__StringLiteral("HAS_OVERLOADED_BOOLEAN_VALUE"), 0x40], ["ObjectProperty", f__StringLiteral("injectDOMPropertyConfig"), function (domPropertyConfig) {
      ...
      for (var __fromJSForIn365 in f__getForInLoopKeyObject(Properties)) {
        var propName;propName = f__getTrackedPropertyName(Properties, __fromJSForIn365);
    ...
    var Danger = f__makeObject([["ObjectProperty", f__StringLiteral("dangerouslyRenderMarkup"), function (markupList) {
      ...
      for (var __fromJSForIn366 in f__getForInLoopKeyObject(markupByNodeName)) {
        nodeName = f__getTrackedPropertyName(markupByNodeName, __fromJSForIn366);
        ...
        var resultIndex;
        for (var __fromJSForIn367 in f__getForInLoopKeyObject(markupListByNodeName)) {
          resultIndex = f__getTrackedPropertyName(markupListByNodeName, __fromJSForIn367);
          nodeName = f__getTrackedPropertyName(markupByNodeName, __fromJSForIn366);
    ...
    var EventPluginHub = f__makeObject([["ObjectProperty", f__StringLiteral("injection"), f__makeObject([["ObjectProperty", f__StringLiteral("injectMount"), EventPluginUtils.injection.injectMount], ["ObjectProperty", f__StringLiteral("injectInstanceHandle"), function (InjectedInstanceHandle) {
      ...
      for (var __fromJSForIn368 in f__getForInLoopKeyObject(listenerBank)) {
        var registrationName;registrationName = f__getTrackedPropertyName(listenerBank, __fromJSForIn368);
    ...
    function recomputePluginOrdering() {
      ...
      for (var __fromJSForIn369 in f__getForInLoopKeyObject(namesToPlugins)) {
        var pluginName;pluginName = f__getTrackedPropertyName(namesToPlugins, __fromJSForIn369);
        ...
        for (var __fromJSForIn370 in f__getForInLoopKeyObject(publishedEvents)) {
          var eventName;eventName = f__getTrackedPropertyName(publishedEvents, __fromJSForIn370);
          var pluginName;pluginName = f__getTrackedPropertyName(namesToPlugins, __fromJSForIn369);
    ...
    function publishEventForPlugin(dispatchConfig, PluginModule, eventName) {
      ...
      if (f__useValue(phasedRegistrationNames)) {
        for (var __fromJSForIn371 in f__getForInLoopKeyObject(phasedRegistrationNames)) {
          var phaseName;phaseName = f__getTrackedPropertyName(phasedRegistrationNames, __fromJSForIn371);
    ...
    var EventPluginRegistry = f__makeObject([["ObjectProperty", f__StringLiteral("plugins"), []], ["ObjectProperty", f__StringLiteral("eventNameDispatchConfigs"), f__makeObject([])], ["ObjectProperty", f__StringLiteral("registrationNameModules"), f__makeObject([])], ["ObjectProperty", f__StringLiteral("registrationNameDependencies"), f__makeObject([])], ["ObjectProperty", f__StringLiteral("injectEventPluginOrder"), function (InjectedEventPluginOrder) {
      ...
      for (var __fromJSForIn372 in f__getForInLoopKeyObject(injectedNamesToPlugins)) {
        var pluginName;pluginName = f__getTrackedPropertyName(injectedNamesToPlugins, __fromJSForIn372);
      ...
      for (var __fromJSForIn373 in f__getForInLoopKeyObject(dispatchConfig.phasedRegistrationNames)) {
        var phase;phase = f__getTrackedPropertyName(dispatchConfig.phasedRegistrationNames, __fromJSForIn373);
      ...
      for (var __fromJSForIn374 in f__getForInLoopKeyObject(namesToPlugins)) {
        var pluginName;pluginName = f__getTrackedPropertyName(namesToPlugins, __fromJSForIn374);
      ...
      for (var __fromJSForIn375 in f__getForInLoopKeyObject(eventNameDispatchConfigs)) {
        var eventName;eventName = f__getTrackedPropertyName(eventNameDispatchConfigs, __fromJSForIn375);
      ...
      for (var __fromJSForIn376 in f__getForInLoopKeyObject(registrationNameModules)) {
        var registrationName;registrationName = f__getTrackedPropertyName(registrationNameModules, __fromJSForIn376);
    ...
    function assign(target, sources) {
      ...
      for (var nextIndex = 1; f__useValue(nextIndex < arguments.length); nextIndex++) {
        ...
        for (var __fromJSForIn377 in f__getForInLoopKeyObject(from)) {
          var key;key = f__getTrackedPropertyName(from, __fromJSForIn377);
    ...
    var ReactChildReconciler = f__makeObject([["ObjectProperty", f__StringLiteral("instantiateChildren"), function (nestedChildNodes, transaction, context) {
      ...
      for (var __fromJSForIn378 in f__getForInLoopKeyObject(children)) {
        var name;name = f__getTrackedPropertyName(children, __fromJSForIn378);
      ...
      var name;
      for (var __fromJSForIn379 in f__getForInLoopKeyObject(nextChildren)) {
        name = f__getTrackedPropertyName(nextChildren, __fromJSForIn379);
      ...
      for (var __fromJSForIn380 in f__getForInLoopKeyObject(prevChildren)) {
        name = f__getTrackedPropertyName(prevChildren, __fromJSForIn380);
      ...
      for (var __fromJSForIn381 in f__getForInLoopKeyObject(renderedChildren)) {
        var name;name = f__getTrackedPropertyName(renderedChildren, __fromJSForIn381);
    ...
    function validateTypeDef(Constructor, typeDef, location) {
      for (var __fromJSForIn382 in f__getForInLoopKeyObject(typeDef)) {
        var propName;propName = f__getTrackedPropertyName(typeDef, __fromJSForIn382);
    ...
    function mixSpecIntoComponent(Constructor, spec) {
      ...
      for (var __fromJSForIn383 in f__getForInLoopKeyObject(spec)) {
        var name;name = f__getTrackedPropertyName(spec, __fromJSForIn383);
    ...
    function mixStaticSpecIntoComponent(Constructor, statics) {
      ...
      for (var __fromJSForIn384 in f__getForInLoopKeyObject(statics)) {
        var name;name = f__getTrackedPropertyName(statics, __fromJSForIn384);
    ...
    function mergeIntoWithNoDuplicateKeys(one, two) {
      ...
      for (var __fromJSForIn385 in f__getForInLoopKeyObject(two)) {
        var key;key = f__getTrackedPropertyName(two, __fromJSForIn385);
    ...
    function bindAutoBindMethods(component) {
      for (var __fromJSForIn386 in f__getForInLoopKeyObject(component.__reactAutoBindMap)) {
        var autoBindKey;autoBindKey = f__getTrackedPropertyName(component.__reactAutoBindMap, __fromJSForIn386);
    ...
    var ReactClass = f__makeObject([["ObjectProperty", f__StringLiteral("createClass"), function (spec) {
      ...
      for (var __fromJSForIn387 in f__getForInLoopKeyObject(ReactClassInterface)) {
        var methodName;methodName = f__getTrackedPropertyName(ReactClassInterface, __fromJSForIn387);
    ...
    if (f__useValue(f__notTripleEqual(f__StringLiteral("production"), f__StringLiteral("development")))) {
      ...
      for (var __fromJSForIn388 in f__getForInLoopKeyObject(deprecatedAPIs)) {
        var fnName;fnName = f__getTrackedPropertyName(deprecatedAPIs, __fromJSForIn388);
    ...
    */
    ...
    var ReactCompositeComponentMixin = f__makeObject([["ObjectProperty", f__StringLiteral("construct"), function (element) {
      ...
      for (var __fromJSForIn389 in f__getForInLoopKeyObject(contextTypes)) {
        var contextName;contextName = f__getTrackedPropertyName(contextTypes, __fromJSForIn389);
      ...
      if (f__useValue(childContext)) {
        ...
        for (var __fromJSForIn390 in f__getForInLoopKeyObject(childContext)) {
          var name;name = f__getTrackedPropertyName(childContext, __fromJSForIn390);
      ...
      for (var __fromJSForIn391 in f__getForInLoopKeyObject(propTypes)) {
        var propName;propName = f__getTrackedPropertyName(propTypes, __fromJSForIn391);
    ...
    var ReactDOMButton = ReactClass.createClass(f__makeObject([["ObjectProperty", f__StringLiteral("displayName"), f__StringLiteral("ReactDOMButton")], ["ObjectProperty", f__StringLiteral("tagName"), f__StringLiteral("BUTTON")], ["ObjectProperty", f__StringLiteral("mixins"), [AutoFocusMixin, ReactBrowserComponentMixin]], ["ObjectProperty", f__StringLiteral("render"), function () {
      ...
      for (var __fromJSForIn392 in f__getForInLoopKeyObject(this.props)) {
        var key;key = f__getTrackedPropertyName(this.props, __fromJSForIn392);
    ...
    f__assign(ReactDOMComponent, f__StringLiteral("Mixin"), f__makeObject([["ObjectProperty", f__StringLiteral("construct"), function (element) {
      ...
      for (var __fromJSForIn393 in f__getForInLoopKeyObject(props)) {
        var propKey;propKey = f__getTrackedPropertyName(props, __fromJSForIn393);
      ...
      var styleName;
      var styleUpdates;
      for (var __fromJSForIn394 in f__getForInLoopKeyObject(lastProps)) {
        propKey = f__getTrackedPropertyName(lastProps, __fromJSForIn394);
        ...
        if (f__useValue(f__tripleEqual(propKey, STYLE))) {
          ...
          for (var __fromJSForIn395 in f__getForInLoopKeyObject(lastStyle)) {
            styleName = f__getTrackedPropertyName(lastStyle, __fromJSForIn395);
            propKey = f__getTrackedPropertyName(lastProps, __fromJSForIn394);
      ...
      for (var __fromJSForIn396 in f__getForInLoopKeyObject(nextProps)) {
        propKey = f__getTrackedPropertyName(nextProps, __fromJSForIn396);
        ...
        if (f__useValue(f__tripleEqual(propKey, STYLE))) {
          ...
          if (f__useValue(lastProp)) {
            ...
            for (var __fromJSForIn397 in f__getForInLoopKeyObject(lastProp)) {
              styleName = f__getTrackedPropertyName(lastProp, __fromJSForIn397);
              propKey = f__getTrackedPropertyName(nextProps, __fromJSForIn396);
            ...
            for (var __fromJSForIn398 in f__getForInLoopKeyObject(nextProp)) {
              styleName = f__getTrackedPropertyName(nextProp, __fromJSForIn398);
              propKey = f__getTrackedPropertyName(nextProps, __fromJSForIn396);
    ...
    function getDOMSummary(measurements) {
      ...
      for (var i = 0; f__useValue(i < measurements.length); i++) {
        ...
        for (var __fromJSForIn399 in f__getForInLoopKeyObject(measurement.writes)) {
          id = f__getTrackedPropertyName(measurement.writes, __fromJSForIn399);
    ...
    function getExclusiveSummary(measurements) {
      ...
      for (var i = 0; f__useValue(i < measurements.length); i++) {
        ...
        for (var __fromJSForIn400 in f__getForInLoopKeyObject(allIDs)) {
          var id;id = f__getTrackedPropertyName(allIDs, __fromJSForIn400);
      ...
      var arr = [];
      for (var __fromJSForIn401 in f__getForInLoopKeyObject(candidates)) {
        displayName = f__getTrackedPropertyName(candidates, __fromJSForIn401);
    ...
    function getInclusiveSummary(measurements, onlyClean) {
      ...
      for (var i = 0; f__useValue(i < measurements.length); i++) {
        ...
        for (var __fromJSForIn402 in f__getForInLoopKeyObject(allIDs)) {
          var id;id = f__getTrackedPropertyName(allIDs, __fromJSForIn402);
      ...
      // Now make a sorted array with the results.
      var arr = [];
      for (var __fromJSForIn403 in f__getForInLoopKeyObject(candidates)) {
        inclusiveKey = f__getTrackedPropertyName(candidates, __fromJSForIn403);
    ...
    function getUnchangedComponents(measurement) {
      ...
      for (var __fromJSForIn404 in f__getForInLoopKeyObject(allIDs)) {
        var id;id = f__getTrackedPropertyName(allIDs, __fromJSForIn404);
    ...
    function defineMutationMembrane(prototype) {
      try {
        ...
        for (var __fromJSForIn405 in f__getForInLoopKeyObject(pseudoFrozenProperties)) {
          var key;key = f__getTrackedPropertyName(pseudoFrozenProperties, __fromJSForIn405);
    ...
    f__assign(ReactElement, f__StringLiteral("createElement"), function (type, config, children) {
      ...
      if (f__useValue(f__notDoubleEqual(config, null))) {
        ...
        for (var __fromJSForIn406 in f__getForInLoopKeyObject(config)) {
          propName = f__getTrackedPropertyName(config, __fromJSForIn406);
      ...
      if (f__useValue(f__useValue((f__setCachedValue(type), f__useValue(f__getCachedValue()))) ? type.defaultProps : f__getCachedValue())) {
        ...
        for (var __fromJSForIn407 in f__getForInLoopKeyObject(defaultProps)) {
          propName = f__getTrackedPropertyName(defaultProps, __fromJSForIn407);
    ...
    f__assign(ReactElement, f__StringLiteral("cloneElement"), function (element, config, children) {
      ...
      if (f__useValue(f__notDoubleEqual(config, null))) {
        ...
        for (var __fromJSForIn408 in f__getForInLoopKeyObject(config)) {
          propName = f__getTrackedPropertyName(config, __fromJSForIn408);
    ...
    function validateChildKeys(node, parentType) {
      if (f__useValue(Array.isArray(node))) {
        ...
        if (f__useValue(iteratorFn)) {
          ...
          for (var __fromJSForIn409 in f__getForInLoopKeyObject(fragment)) {
            var key;key = f__getTrackedPropertyName(fragment, __fromJSForIn409);
    ...
    function checkPropTypes(componentName, propTypes, props, location) {
      for (var __fromJSForIn410 in f__getForInLoopKeyObject(propTypes)) {
        var propName;propName = f__getTrackedPropertyName(propTypes, __fromJSForIn410);
    ...
    function checkAndWarnForMutatedProps(element) {
      ...
      for (var __fromJSForIn411 in f__getForInLoopKeyObject(props)) {
        var propName;propName = f__getTrackedPropertyName(props, __fromJSForIn411);
    ...
    */
    ...
    if (f__useValue(f__notTripleEqual(f__StringLiteral("production"), f__StringLiteral("development")))) {
      ...
      var didWarnForFragment = function (fragment) {
        ...
        for (var __fromJSForIn412 in f__getForInLoopKeyObject(fragment)) {
          var key;key = f__getTrackedPropertyName(fragment, __fromJSForIn412);
    ...
    var ReactFragment = f__makeObject([["ObjectProperty", f__StringLiteral("create"), function (object) {
      if (f__useValue(f__notTripleEqual(f__StringLiteral("production"), f__StringLiteral("development")))) {
        ...
        if (f__useValue(canWarnForReactFragment)) {
          ...
          for (var __fromJSForIn413 in f__getForInLoopKeyObject(object)) {
            var key;key = f__getTrackedPropertyName(object, __fromJSForIn413);
      ...
      if (f__useValue(f__notTripleEqual(f__StringLiteral("production"), f__StringLiteral("development")))) {
        if (f__useValue(canWarnForReactFragment)) {
          ...
          for (var __fromJSForIn414 in f__getForInLoopKeyObject(fragment)) {
            var key;key = f__getTrackedPropertyName(fragment, __fromJSForIn414);
    ...
    var ReactMultiChild = f__makeObject([["ObjectProperty", f__StringLiteral("Mixin"), f__makeObject([["ObjectProperty", f__StringLiteral("mountChildren"), function (nestedChildren, transaction, context) {
      ...
      var mountImages = [];
      var index = 0;
      for (var __fromJSForIn415 in f__getForInLoopKeyObject(children)) {
        var name;name = f__getTrackedPropertyName(children, __fromJSForIn415);
      ...
      try {
        ...
        for (var __fromJSForIn416 in f__getForInLoopKeyObject(prevChildren)) {
          var name;name = f__getTrackedPropertyName(prevChildren, __fromJSForIn416);
      ...
      var lastIndex = 0;
      var nextIndex = 0;
      for (var __fromJSForIn417 in f__getForInLoopKeyObject(nextChildren)) {
        name = f__getTrackedPropertyName(nextChildren, __fromJSForIn417);
      ...
      for (var __fromJSForIn418 in f__getForInLoopKeyObject(prevChildren)) {
        name = f__getTrackedPropertyName(prevChildren, __fromJSForIn418);
    ...
    var ReactPerf = f__makeObject([["ObjectProperty", f__StringLiteral("enableMeasure"), false], ["ObjectProperty", f__StringLiteral("storedMeasure"), _noMeasure], ["ObjectProperty", f__StringLiteral("measureMethods"), function (object, objectName, methodNames) {
      if (f__useValue(f__notTripleEqual(f__StringLiteral("production"), f__StringLiteral("development")))) {
        for (var __fromJSForIn419 in f__getForInLoopKeyObject(methodNames)) {
          var key;key = f__getTrackedPropertyName(methodNames, __fromJSForIn419);
    ...
    function transferInto(props, newProps) {
      for (var __fromJSForIn420 in f__getForInLoopKeyObject(newProps)) {
        var thisKey;thisKey = f__getTrackedPropertyName(newProps, __fromJSForIn420);
    ...
    function createObjectOfTypeChecker(typeChecker) {
      function validate(props, propName, componentName, location) {
        ...
        for (var __fromJSForIn421 in f__getForInLoopKeyObject(propValue)) {
          var key;key = f__getTrackedPropertyName(propValue, __fromJSForIn421);
    ...
    function createShapeTypeChecker(shapeTypes) {
      function validate(props, propName, componentName, location) {
        ...
        for (var __fromJSForIn422 in f__getForInLoopKeyObject(shapeTypes)) {
          var key;key = f__getTrackedPropertyName(shapeTypes, __fromJSForIn422);
    ...
    function isNode(propValue) {
      switch (f__useValue(f__useValue(typeof propValue === "undefined") ? "undefined" : f__typeof(propValue))) {
        ...
        case f__useValue(f__StringLiteral("object")):
          ...
          for (var __fromJSForIn423 in f__getForInLoopKeyObject(propValue)) {
            var k;k = f__getTrackedPropertyName(propValue, __fromJSForIn423);
    ...
    var ReactTestUtils = f__makeObject([["ObjectProperty", f__StringLiteral("renderIntoDocument"), function (instance) {
      ...
      if (f__useValue(ReactTestUtils.isDOMComponent(inst))) {
        ...
        var key;
        for (var __fromJSForIn424 in f__getForInLoopKeyObject(renderedChildren)) {
          key = f__getTrackedPropertyName(renderedChildren, __fromJSForIn424);
    ...
    function buildSimulators() {
      ...
      var eventType;
      for (var __fromJSForIn425 in f__getForInLoopKeyObject(ReactBrowserEventEmitter.eventNameDispatchConfigs)) {
        eventType = f__getTrackedPropertyName(ReactBrowserEventEmitter.eventNameDispatchConfigs, __fromJSForIn425);
    ...
    var eventType;
    for (var __fromJSForIn426 in f__getForInLoopKeyObject(topLevelTypes)) {
      eventType = f__getTrackedPropertyName(topLevelTypes, __fromJSForIn426);
    ...
    var ReactTransitionChildMapping = f__makeObject([["ObjectProperty", f__StringLiteral("getChildMapping"), function (children) {
      ...
      var pendingKeys = [];
      for (var __fromJSForIn427 in f__getForInLoopKeyObject(prev)) {
        var prevKey;prevKey = f__getTrackedPropertyName(prev, __fromJSForIn427);
      ...
      for (var __fromJSForIn428 in f__getForInLoopKeyObject(next)) {
        var nextKey;nextKey = f__getTrackedPropertyName(next, __fromJSForIn428);
    ...
    function detectEvents() {
      ...
      for (var __fromJSForIn429 in f__getForInLoopKeyObject(EVENT_NAME_MAP)) {
        var baseEventName;baseEventName = f__getTrackedPropertyName(EVENT_NAME_MAP, __fromJSForIn429);

        var baseEvents = EVENT_NAME_MAP[baseEventName];
        for (var __fromJSForIn430 in f__getForInLoopKeyObject(baseEvents)) {
          var styleName;styleName = f__getTrackedPropertyName(baseEvents, __fromJSForIn430);
          var baseEventName;baseEventName = f__getTrackedPropertyName(EVENT_NAME_MAP, __fromJSForIn429);
    ...
    var ReactTransitionGroup = React.createClass(f__makeObject([["ObjectProperty", f__StringLiteral("displayName"), f__StringLiteral("ReactTransitionGroup")], ["ObjectProperty", f__StringLiteral("propTypes"), f__makeObject([["ObjectProperty", f__StringLiteral("component"), React.PropTypes.any], ["ObjectProperty", f__StringLiteral("childFactory"), React.PropTypes.func]])], ["ObjectProperty", f__StringLiteral("getDefaultProps"), function () {
      ...
      for (var __fromJSForIn431 in f__getForInLoopKeyObject(initialChildMapping)) {
        var key;key = f__getTrackedPropertyName(initialChildMapping, __fromJSForIn431);
      ...
      for (var __fromJSForIn432 in f__getForInLoopKeyObject(nextChildMapping)) {
        key = f__getTrackedPropertyName(nextChildMapping, __fromJSForIn432);
      ...
      for (var __fromJSForIn433 in f__getForInLoopKeyObject(prevChildMapping)) {
        key = f__getTrackedPropertyName(prevChildMapping, __fromJSForIn433);
      ...
      for (var __fromJSForIn434 in f__getForInLoopKeyObject(this.state.children)) {
        var key;key = f__getTrackedPropertyName(this.state.children, __fromJSForIn434);
    ...
    for (var __fromJSForIn435 in f__getForInLoopKeyObject(topLevelEventsToDispatchConfig)) {
      var type;type = f__getTrackedPropertyName(topLevelEventsToDispatchConfig, __fromJSForIn435);
    ...
    function SyntheticEvent(dispatchConfig, dispatchMarker, nativeEvent) {
      ...
      for (var __fromJSForIn436 in f__getForInLoopKeyObject(Interface)) {
        var propName;propName = f__getTrackedPropertyName(Interface, __fromJSForIn436);
    ...
    assign(SyntheticEvent.prototype, f__makeObject([["ObjectProperty", f__StringLiteral("preventDefault"), function () {
      ...
      var Interface = this.constructor.Interface;
      for (var __fromJSForIn437 in f__getForInLoopKeyObject(Interface)) {
        var propName;propName = f__getTrackedPropertyName(Interface, __fromJSForIn437);
    ...
    var keyMirror = function (obj) {
      ...
      for (var __fromJSForIn438 in f__getForInLoopKeyObject(obj)) {
        key = f__getTrackedPropertyName(obj, __fromJSForIn438);
    ...
    var keyOf = function (oneKeyObj) {
      var key;
      for (var __fromJSForIn439 in f__getForInLoopKeyObject(oneKeyObj)) {
        key = f__getTrackedPropertyName(oneKeyObj, __fromJSForIn439);
    ...
    function mapObject(object, callback, context) {
      ...
      var result = f__makeObject([]);
      for (var __fromJSForIn440 in f__getForInLoopKeyObject(object)) {
        var name;name = f__getTrackedPropertyName(object, __fromJSForIn440);
    ...
    function shallowEqual(objA, objB) {
      ...
      for (var __fromJSForIn441 in f__getForInLoopKeyObject(objA)) {
        key = f__getTrackedPropertyName(objA, __fromJSForIn441);
      ...
      for (var __fromJSForIn442 in f__getForInLoopKeyObject(objB)) {
        key = f__getTrackedPropertyName(objB, __fromJSForIn442);
    ...
    function traverseAllChildrenImpl(children, nameSoFar, indexSoFar, callback, traverseContext) {
      ...
      if (f__useValue(Array.isArray(children))) {
        ...
        if (f__useValue(iteratorFn)) {
          ...
          for (var __fromJSForIn443 in f__getForInLoopKeyObject(fragment)) {
            var key;key = f__getTrackedPropertyName(fragment, __fromJSForIn443);
    ...
    function update(value, spec) {
      ...
      for (var __fromJSForIn444 in f__getForInLoopKeyObject(spec)) {
        var k;k = f__getTrackedPropertyName(spec, __fromJSForIn444);
