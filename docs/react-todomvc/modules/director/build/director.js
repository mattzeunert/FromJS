...
(function (exports) {
  ...
  f__assign(Router.prototype, f__StringLiteral('getPath'), function () {
    var path = f__getPathname(window.location);
  ...
  function paramifyString(str, params, mod) {
    mod = str;
    for (var __fromJSForIn359 in f__getForInLoopKeyObject(params)) {
      var param;param = f__getTrackedPropertyName(params, __fromJSForIn359);
  ...
  f__assign(Router.prototype, f__StringLiteral('traverse'), function (method, path, routes, regexp, filter) {
    ...
    for (var __fromJSForIn360 in f__getForInLoopKeyObject(routes)) {
      var r;r = f__getTrackedPropertyName(routes, __fromJSForIn360);
  ...
  f__assign(Router.prototype, f__StringLiteral('mount'), function (routes, path) {
    ...
    for (var __fromJSForIn361 in f__getForInLoopKeyObject(routes)) {
      var route;route = f__getTrackedPropertyName(routes, __fromJSForIn361);
